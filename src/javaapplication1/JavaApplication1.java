...
public class JavaApplication1 {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if ("adult".equals(user.get(0)) || "senior".equals(user.get(0))) {
                while (pay == false) {
                    ...
                    switch (choice2) {
                        ...
                        case "2":
                            ...
                            for (Adult adult : adults) {
                                if (adult.getName().equals(user.get(1))) {
                                    adult.totalAmountPaid();
                                    retrieve();
                                    System.out.println("\nYour total payment is " + adult.getTotalAmount());
                                    end = true;
                                    break;
                                }
                            }
                            ...
                            for (Senior senior : seniors) {
                                if (senior.getName().equals(user.get(1))) {
            ...
            } else if ("pharmacist".equals(user.get(0))) {
                while (logOutP == false) {
                    System.out.println("\n C H O I C E S \n1 -- View Medicines\n2 -- Add Medicine\n3 -- Remove Medicine\n4 -- Log Out\n");
                    System.out.print("Enter choice : ");
