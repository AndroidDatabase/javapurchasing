 ...
 */
public class DeleteCough extends javax.swing.JFrame {

    /**
     * Creates new form DeleteCough
     */
    public DeleteCough() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DELETE MEDICINES");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteCough.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteCough().setVisible(true);
            }
        });
    }
