 ...
 */
public class AllergyPhar extends javax.swing.JFrame {

    /**
     * Creates new form AllergyPhar
     */
    public AllergyPhar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("ALLERGY MEDICINES");

        Category.setBackground(new java.awt.Color(204, 204, 204));
        Category.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        Category.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "View Medicine", "Add Medicine", "Remove Medicine" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AllergyPhar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AllergyPhar().setVisible(true);
            }
        });
    }
